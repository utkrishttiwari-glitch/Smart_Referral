...
const roles = [
  ...
  { id: "medical-staff/consultation", title: "Medical Staff", description: "Follow assigned patients and consult verified doctors during transport." },
  { id: "medicine-provider", title: "Medicine Provider", description: "Update local medicine availability for patients." },
];
